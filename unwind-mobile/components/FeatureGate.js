...
/**
 * FeatureGate - Wraps premium features and controls access
 * 
 * Usage:
...
const FeatureGate = ({ 
  ...
  const { hasFeature, hasTier, membership } = useMembership();
  ...
  // If not showing upgrade prompt, return null (hidden)
  if (!showUpgradePrompt) {
    return null;
  }

  // Determine required tier for display
  const requiredTier = tier || (feature ? "Pro" : "Premium");
      ...
      <BlurView intensity={80} style={styles.blurContainer}>
        <View style={styles.overlayContent}>
          ...
          <Text style={styles.description}>
            This feature requires a {requiredTier} membership
          </Text>
          ...
          <View style={styles.currentTierBadge}>
            ...
            <Text style={styles.currentTierText}>
              Current Plan: {membership.tier.toUpperCase()}
            </Text>
          </View>
        </View>
      </BlurView>
